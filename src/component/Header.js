  ...
  render() {
    ...
    return (
      <div>
        ...
        <h3 style={style.head}>Vertically Integrated Projects - VIP</h3>
              ...
              <MuiThemeProvider muiTheme={getMuiTheme(darkBaseTheme)}>
                <div>
                  ...
                  <div className="hidden-xs"> 
                    ...
                    <Link to="/projects"><FlatButton label="For Students" className="menuBarButton"/></Link>
                    <Link to="/faculty"><FlatButton label="For Faculty" className="menuBarButton"/></Link>
