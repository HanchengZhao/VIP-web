...
class FacultyFieldSet extends Component{
  constructor() {
      super();
      this.state = {
        gpa:'',
  ...
  firebasewrite = () => {
    /*if(Validation(this.state.email)){*/
      if(`${db}`==='Team Application'){
          ...
          //leadFaculty : this.state.leadFaculty,
         ...
         // advisor: this.state.advisors,
          problemAddressed: this.state.problemAddressed,
              ...
              <Card>
                ...
                <div className="row">
                  ...
                  <TextField questionArray={questionsArray[id]} var={questionsArray[id].id}
                    ...
                    : (<h2>Loading..</h2>) }                
                <br/>
                <RaisedButton label="ADD OTHER FACULTY" style={style} backgroundColor='#ffc627'/> <br />
                    <RaisedButton label="ADD INDUSTRY LEADER" style={style} backgroundColor='#ffc627'/>
                </div>
...
export default FacultyFieldSet;