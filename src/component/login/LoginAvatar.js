...
const styles = {photo : {height:"40px", width:"40px", marginRight:"10", display:"inline-block"}, userName : {color:"#f9f9f9", paddingTop:"20", marginRight:"20", display:"inline-block"}, container:{float:"right", height:"60px"}};
